...
const ActionButton = ({
  ...
  const variantClasses = {
    ...
    danger:
      'bg-red-600 text-white focus:ring-red-500 focus:outline-none focus:ring-2 focus:ring-offset-2',
    success:
      'bg-green-600 text-white focus:ring-green-500 focus:outline-none focus:ring-2 focus:ring-offset-2',
    none: 'bg-transparent text-inherit focus:ring-transparent focus:ring-offset-transparent',
    link: 'bg-transparent text-blended-blue_6 underline focus:ring-transparent focus:ring-offset-transparent',
  };
