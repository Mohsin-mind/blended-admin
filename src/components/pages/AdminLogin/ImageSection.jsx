...
function ChatBubble({ text }) {
  return (
    <div className='bg-blended-blue_8/20 backdrop-blur-sm rounded-2xl px-4 py-2 border border-white/30 shadow-lg relative'>
      ...
      <div className='absolute bottom-0 left-4 w-0 h-0 border-r-[14px] border-t-[14px] border-l-0 border-l-transparent border-r-transparent border-t-blended-blue_8/20  transform translate-y-full' />
    </div>
  );
}
function ImageSection({
  ...
  return (
    <div className='w-full h-full relative'>
      ...
      {/* Chat Bubbles */}
      <div className='absolute top-[35%] right-[9%] max-w-[185px] flex flex-col items-center justify-center space-y-6'>
        {/* Hello Bubble */}
